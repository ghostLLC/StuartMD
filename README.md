...
**下载：** [GitHub Releases](https://github.com/ghostLLC/StuartMD/releases) · 最新安装包 `StuartMD-Setup-3.1.1.exe`
...
1. 安装 `StuartMD-Setup-3.1.1.exe`（默认 `%LOCALAPPDATA%\StuartMD`）
2. 打开示例或任意 `.md` / `.pdf`
