...
# Version sync
check('"3.0.8"' in cargo and "3.0.8" in cargo, "Cargo.toml 3.0.8")
check('name = "stuartmd"' in lock and "3.0.8" in lock, "Cargo.lock stuartmd 3.0.8")
check('"version": "3.0.8"' in conf, "tauri.conf.json 3.0.8")
check('VERSION: &str = "3.0.8"' in fs, "fs_api VERSION 3.0.8")
